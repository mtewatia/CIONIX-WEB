...
const steps = [
  {
    number: "01",
    icon: Compass,
    title: "Connect With the Right Division",
    description: "Tell us what you need — we'll route you to the specialized CIONIX company best suited for your industry, whether it's tech, media, healthcare, or real estate.",
  ...
  },
  {
    ...
    description: "Your dedicated division's veterans — not generalists — craft a tailored strategy using years of industry-specific knowledge and proven frameworks.",
  ...
  },
  {
    ...
    description: "Each project is delivered by the team that knows your industry inside-out — from development sprints and production shoots to billing cycles and property analysis.",
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    number: "04",
    icon: BarChart3,
    title: "Cross-Sector Growth",
    description: "As your business grows, unlock the power of CIONIX's other divisions — seamlessly add marketing, media, tech, or advisory capabilities without starting from scratch.",

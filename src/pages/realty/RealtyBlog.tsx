...
const RealtyBlog = () => {
  const posts = getBlogsBySector("realty");
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="section-padding">
        <div className="container-custom">
          {featured && (
            <Link to={`/realty/blog/${featured.id}`} className="card-ryse overflow-hidden block mb-12 group">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {rest.map((post) => (
              <Link key={post.id} to={`/realty/blog/${post.id}`} className="card-ryse overflow-hidden group">
